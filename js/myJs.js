...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu đẹp trai quá! ";
    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Kết bạn zalo với tớ nha sđt: 0886244991 :vvv, Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://www.facebook.com/trandinhthanh.official';
                  }
            })
        }
    })
